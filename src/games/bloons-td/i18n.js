export default {
  'bloons.towerDart':     { es: 'Dardo ($50)',          en: 'Dart ($50)' },
  'bloons.towerCannon':   { es: 'Cañón ($100)',         en: 'Cannon ($100)' },
  'bloons.towerSniper':   { es: 'Francotirador ($200)', en: 'Sniper ($200)' },
  'bloons.lives':         { es: 'Vidas: {n}',           en: 'Lives: {n}' },
  'bloons.money':         { es: 'Dinero: ${n}',          en: 'Money: ${n}' },
  'bloons.record':        { es: 'Récord: {n}',          en: 'Record: {n}' },
  'bloons.towers':        { es: 'TORRES',                en: 'TOWERS' },
  'bloons.waveComplete':  { es: '¡Oleada {n} superada!', en: 'Wave {n} complete!' },
  'bloons.nextWave':      { es: 'Click o Espacio para empezar', en: 'Click or Space to start' },

...
**Nivel 4 — Estrategia / Defensa Torre**
...
| Aspecto | Descripción |
|---------|-------------|
| **Objetivo** | Sobrevivir 15 oleadas |
| **Victoria** | Completar la oleada 15 |
| **Derrota** | Perder todas las vidas (20) |
| **Puntuación** | Puntos por bloon eliminado (según tipo) |
...
| Módulo | Uso |
|--------|-----|
| `InputManager` | Ratón + teclado (1/2/3/P/Espacio) |

export default {
  'harrier.score':      { es: 'PUNTOS: {n}',         en: 'SCORE: {n}' },
  'harrier.lives':      { es: 'VIDAS: {n}',          en: 'LIVES: {n}' },
  'harrier.stage':      { es: 'ETAPA {n}',           en: 'STAGE {n}' },
  'harrier.power':      { es: 'POW: {n}',            en: 'POW: {n}' },
  'harrier.charge':     { es: 'CARGA',               en: 'CHARGE' },
  'harrier.stageClear': { es: '¡ETAPA COMPLETA!',    en: 'STAGE COMPLETE!' },
  'harrier.gameOver':   { es: 'GAME OVER',            en: 'GAME OVER' },
  'harrier.boss':       { es: '⚠️ JEFE',             en: '⚠️ BOSS' },
  'harrier.go':         { es: '¡GO!',                 en: 'GO!' },

export default {
  'asteroids.score':   { es: 'Puntos: {n}',   en: 'Score: {n}' },
  'asteroids.lives':   { es: 'Vidas: {n}',     en: 'Lives: {n}' },
  'asteroids.wave':    { es: 'Oleada: {n}',    en: 'Wave: {n}' },
  'asteroids.record':  { es: 'Récord: {n}',    en: 'Record: {n}' },
